/**
 * ChatAssistant - inlined to avoid React version conflict with @tab/chat-assistant package.
 * Same UI: compact popup with conversation bubbles, model dropdown, purple Send button.
 */
...
export default function ChatAssistantInline({
  apiBase = '',
  context = '',
  ...
  return (
    <>
      {!open && (
        <div className="fixed bottom-6 right-6 z-[9998] flex flex-col items-end gap-1">
          <div className="rounded-lg bg-gray-800 text-white text-sm px-3 py-2 shadow-lg">
            How may I help you?
          </div>
          <button
